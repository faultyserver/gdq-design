...
function Introduction() {
  return (
    <Stack spacing="space-lg">
      ...
      <Text>
        GDQ uses two primary font faces for text: Barlow and Source Sans Pro. Barlow is a display
        font, used primarily for headers and accent text (like button labels), while Source Sans Pro
        is suited for normal text like body copy, form labels and notes, and any other longer-form
        content.
      </Text>
      <Text>
